# bmi_calc
this repo contain bmi calculator code that help to calculate bmi based on height and weight perameter and store data into data table weather bmi is under weight or overweight.
with the help of json and pandas module in python.
```
import json
import pandas as pd

# table2 is table that contain coloumns as BMI category, BMI Range, Health Risk etc.
